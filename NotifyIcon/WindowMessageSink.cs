...
namespace ManagedWin32.Api
{
    ...
    public class WindowMessageSink : IDisposable
    {
        ...
        void CreateMessageWindow()
        {
            ...
            MessageWindowHandle = User32.CreateWindowEx(0, WindowId, "", 0, 0, 0, 1, 1, IntPtr.Zero, IntPtr.Zero,
                IntPtr.Zero, IntPtr.Zero);

            if (MessageWindowHandle == IntPtr.Zero) throw new Win32Exception("Message window handle was not a valid pointer");
        }
        #endregion
        ...
        /// </summary>
        IntPtr OnWindowMessageReceived(IntPtr hwnd, uint messageId, IntPtr wparam, IntPtr lparam)
        {
        ...
        void ProcessWindowMessage(uint msg, IntPtr wParam, IntPtr lParam)
        {
